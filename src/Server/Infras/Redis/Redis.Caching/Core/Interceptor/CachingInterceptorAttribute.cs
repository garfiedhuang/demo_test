namespace Hkust.Infras.Redis.Caching.Core.Interceptor
{
    ...
    /// <summary>
    /// Hkust.Infras.Redis interceptor attribute.
    /// </summary>
    ...
    public class CachingInterceptorAttribute : Attribute
    {
        ...
        /// <summary>
        /// Gets or sets the cache provider name. The default value is Hkust.Infras.RedisInterceptorOptions.CacheProviderName"/>
        /// </summary>
        /// <value>The cache key prefix.</value>
