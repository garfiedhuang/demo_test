namespace Hkust.Infras.Redis.Caching.Core.Diagnostics
{
    /// <summary>
    /// Extension methods on the DiagnosticListener class to log Hkust.Infras.Redis
    /// </summary>
    public static class CachingDiagnosticListenerExtensions
    {
        ...
        private const string CachingPrefix = nameof(Hkust.Infras.Redis.Caching);
