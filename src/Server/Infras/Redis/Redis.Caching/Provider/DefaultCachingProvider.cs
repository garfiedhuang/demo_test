...
using Hkust.Infras.Redis.Caching.Core;
using Hkust.Infras.Redis.Configurations;
using Hkust.Infras.Redis.Core;
using Hkust.Infras.Redis.Core.Serialization;
using Hkust.Infras.Redis.Providers.StackExchange;

namespace Hkust.Infras.Redis.Caching.Provider;
...
public partial class DefaultCachingProvider : AbstracCacheProvider, ICacheProvider
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="T:Hkust.Infras.Redis.Redis.DefaultRedisCachingProvider"/> class.
    /// </summary>
    ...
    private RedisKey[] SearchRedisKeys(string pattern)
    {
        ...
        foreach (var server in _servers)
            ...
            // see https://github.com/dotnetcore/Hkust.Infras.Redis/pull/199 for more information
