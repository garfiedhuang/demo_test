using Hkust.Infras.Core.Json;
using Hkust.Infras.Redis.Core.Internal;

namespace Hkust.Infras.Redis.Core.Serialization
{
    /// <summary>
    ...
    public class DefaultJsonSerializer : ISerializer
    {
        ...
        /// The json serializer.
        /// </summary>
        private static readonly JsonSerializerOptions jsonSerializerOption = SystemTextJson.GetHkustDefaultOptions();
