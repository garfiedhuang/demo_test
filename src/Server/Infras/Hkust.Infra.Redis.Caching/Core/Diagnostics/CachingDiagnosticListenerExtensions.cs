namespace Hkust.Infra.Redis.Caching.Core.Diagnostics
{
    /// <summary>
    /// Extension methods on the DiagnosticListener class to log Hkust.Infra.Redis
    /// </summary>
    public static class CachingDiagnosticListenerExtensions
    {
        ...
        private const string CachingPrefix = nameof(Hkust.Infra.Redis.Caching);
