namespace Hkust.Infra.Redis.Caching.Core
{
    /// <summary>
    /// Cache value.
    /// </summary>
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="T:Hkust.Infra.Redis.Core.CacheValue`1"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets a value indicating whether this <see cref="T:Hkust.Infra.Redis.Core.CacheValue`1"/> has value.
        /// </summary>
        /// <value><c>true</c> if has value; otherwise, <c>false</c>.</value>
        public bool HasValue { get; }

        /// <summary>
        /// Gets a value indicating whether this <see cref="T:Hkust.Infra.Redis.Core.CacheValue`1"/> is null.
        /// </summary>
