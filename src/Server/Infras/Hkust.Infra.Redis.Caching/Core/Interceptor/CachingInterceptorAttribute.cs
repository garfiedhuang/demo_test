namespace Hkust.Infra.Redis.Caching.Core.Interceptor
{
    using System;

    /// <summary>
    /// Hkust.Infra.Redis interceptor attribute.
    /// </summary>
    ...
    public class CachingInterceptorAttribute : Attribute
    {
        ...
        /// <summary>
        /// Gets or sets the cache provider name. The default value is Hkust.Infra.RedisInterceptorOptions.CacheProviderName"/>
        /// </summary>
        /// <value>The cache key prefix.</value>
