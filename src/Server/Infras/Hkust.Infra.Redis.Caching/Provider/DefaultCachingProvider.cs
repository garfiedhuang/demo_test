...
using Hkust.Infra.Redis.Caching.Core;
using Hkust.Infra.Redis.Configurations;
using Hkust.Infra.Redis.Core;
using Hkust.Infra.Redis.Core.Serialization;
using Hkust.Infra.Redis.Providers.StackExchange;

namespace Hkust.Infra.Redis.Caching.Provider;
...
public partial class DefaultCachingProvider : AbstracCacheProvider, ICacheProvider
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="T:Hkust.Infra.Redis.Redis.DefaultRedisCachingProvider"/> class.
    /// </summary>
    ...
    private RedisKey[] SearchRedisKeys(string pattern)
    {
        ...
        foreach (var server in _servers)
            ...
            // see https://github.com/dotnetcore/Hkust.Infra.Redis/pull/199 for more information
