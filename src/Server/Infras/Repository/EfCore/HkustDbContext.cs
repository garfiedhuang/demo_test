namespace Hkust.Infras.Repository.EfCore;

public abstract class HkustDbContext : DbContext
{
    private readonly IEntityInfo _entityInfo;

    protected HkustDbContext(DbContextOptions options,IEntityInfo entityInfo)
        : base(options)
    {
