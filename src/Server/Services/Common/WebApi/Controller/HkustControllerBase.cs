...
public abstract class HkustControllerBase : ControllerBase
{
    /// <summary>
    /// Hkust.Common.Application.Services.ProblemDetails.ProblemDetails => Problem
    /// </summary>
    /// <param name="problemDetails"><see cref="Hkust.Common.Application.Services.ProblemDetails"/></param>
    /// <returns><see cref="ObjectResult"/></returns>
    [NonAction]
    protected virtual ObjectResult Problem(Hkust.Common.Application.Contracts.ResultModels.ProblemDetails problemDetails)
    {
