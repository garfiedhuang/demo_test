...
using Hkust.Common.Consts.RegistrationCenter;
using Hkust.Common.Rpc.Handlers;
...
public abstract partial class AbstractApplicationDependencyRegistrar
{
     ...
     where TRestClient : class
    {
        ...
        var contentSerializer = new SystemTextJsonContentSerializer(SystemTextJson.GetHkustDefaultOptions());
