namespace Hkust.Common.Application.Contracts.ResultModels;
...
public sealed class ProblemDetails
{
    ...
    public override string ToString() => JsonSerializer.Serialize(this, SystemTextJson.GetHkustDefaultOptions());
