namespace Hkust.Maint.WebApi.Controllers;
...
[Route("maint/dicts")]
[ApiController]
public class DictController : HkustControllerBase
{
    ...
    /// <returns></returns>
    [HttpPost]
    [HkustAuthorize(PermissionConsts.Dict.Create)]
    ...
    /// <returns></returns>
    [HttpPut("{id}")]
    [HkustAuthorize(PermissionConsts.Dict.Update)]
    ...
    /// <returns></returns>
    [HttpDelete("{id}")]
    [HkustAuthorize(PermissionConsts.Dict.Delete)]
    [ProducesResponseType(StatusCodes.Status204NoContent)]
    ...
    /// <returns></returns>
    [HttpGet()]
    [HkustAuthorize(PermissionConsts.Dict.GetList)]
    ...
    /// <returns></returns>
    [HttpGet("{id}")]
    [HkustAuthorize(PermissionConsts.Dict.GetList, HkustAuthorizeAttribute.JwtWithBasicSchemes)]
    [ProducesResponseType(StatusCodes.Status200OK)]
