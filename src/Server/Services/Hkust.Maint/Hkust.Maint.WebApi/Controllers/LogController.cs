...
public class LogController : HkustControllerBase
{
    ...
    /// <returns></returns>
    [HttpGet("opslogs")]
    [HkustAuthorize(PermissionConsts.Log.GetListForOperationLog)]
    ...
    /// <returns></returns>
    [HttpGet("loginlogs")]
    [HkustAuthorize(PermissionConsts.Log.GetListForLogingLog)]
    ...
    /// <returns></returns>
    [HttpGet("nloglogs")]
    [HkustAuthorize(PermissionConsts.Log.GetListForNLog)]
