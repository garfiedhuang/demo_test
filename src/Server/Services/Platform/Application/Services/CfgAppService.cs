namespace Hkust.Platform.Application.Services;
...
public class CfgAppService : AbstractAppService, ICfgAppService
{
    ...
    public async Task<AppSrvResult<long>> CreateAsync(CfgCreationDto input)
    {
        ...
        var cacheKey = _cacheService.ConcatCacheKey(MaintCachingConsts.CfgSingleKeyPrefix, cfg.Id);
        var cahceBf = _bloomFilterFactory.Create(MaintCachingConsts.BloomfilterOfCacheKey);
