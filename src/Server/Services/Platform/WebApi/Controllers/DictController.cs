...
public class DictController : HkustControllerBase
{
    ...
    /// <returns></returns>
    [HttpPost]
    [HkustAuthorize(MaintPermissionConsts.Dict.Create)]
    ...
    /// <returns></returns>
    [HttpPut("{id}")]
    [HkustAuthorize(MaintPermissionConsts.Dict.Update)]
    ...
    /// <returns></returns>
    [HttpDelete("{id}")]
    [HkustAuthorize(MaintPermissionConsts.Dict.Delete)]
    [ProducesResponseType(StatusCodes.Status204NoContent)]
    ...
    /// <returns></returns>
    [HttpGet()]
    [HkustAuthorize(MaintPermissionConsts.Dict.GetList)]
    ...
    /// <returns></returns>
    [HttpGet("{id}")]
    [HkustAuthorize(MaintPermissionConsts.Dict.GetList, HkustAuthorizeAttribute.JwtWithBasicSchemes)]
    [ProducesResponseType(StatusCodes.Status200OK)]
