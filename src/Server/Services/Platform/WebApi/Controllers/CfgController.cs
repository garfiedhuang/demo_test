...
public class CfgController : HkustControllerBase
{
    ...
    /// <returns></returns>
    [HttpPost]
    [HkustAuthorize(MaintPermissionConsts.Cfg.Create)]
    ...
    /// <returns></returns>
    [HttpPut("{id}")]
    [HkustAuthorize(MaintPermissionConsts.Cfg.Update)]
    ...
    /// <returns></returns>
    [HttpDelete("{id}")]
    [HkustAuthorize(MaintPermissionConsts.Cfg.Delete)]
    [ProducesResponseType(StatusCodes.Status204NoContent)]
    ...
    /// <returns></returns>
    [HttpGet("{id}")]
    [HkustAuthorize(MaintPermissionConsts.Cfg.GetList, HkustAuthorizeAttribute.JwtWithBasicSchemes)]
    ...
    [HttpGet()]
    [HkustAuthorize(MaintPermissionConsts.Cfg.GetList)]
    [ProducesResponseType(StatusCodes.Status200OK)]
