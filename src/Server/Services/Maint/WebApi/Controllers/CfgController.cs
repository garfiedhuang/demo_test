...
[Route("maint/cfgs")]
[ApiController]
public class CfgController : HkustControllerBase
{
    ...
    /// <returns></returns>
    [HttpPost]
    [HkustAuthorize(PermissionConsts.Cfg.Create)]
    ...
    /// <returns></returns>
    [HttpPut("{id}")]
    [HkustAuthorize(PermissionConsts.Cfg.Update)]
    ...
    /// <returns></returns>
    [HttpDelete("{id}")]
    [HkustAuthorize(PermissionConsts.Cfg.Delete)]
    [ProducesResponseType(StatusCodes.Status204NoContent)]
    ...
    /// <returns></returns>
    [HttpGet("{id}")]
    [HkustAuthorize(PermissionConsts.Cfg.GetList, HkustAuthorizeAttribute.JwtWithBasicSchemes)]
    ...
    [HttpGet()]
    [HkustAuthorize(PermissionConsts.Cfg.GetList)]
    [ProducesResponseType(StatusCodes.Status200OK)]
