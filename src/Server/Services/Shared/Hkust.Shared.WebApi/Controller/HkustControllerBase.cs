...
{
    /// <summary>
    /// Hkust.Shared.Application.Services.ProblemDetails.ProblemDetails => Problem
    /// </summary>
    /// <param name="problemDetails"><see cref="Hkust.Shared.Application.Services.ProblemDetails"/></param>
    /// <returns><see cref="ObjectResult"/></returns>
    [NonAction]
    protected virtual ObjectResult Problem(Hkust.Shared.Application.Contracts.ResultModels.ProblemDetails problemDetails)
    {
